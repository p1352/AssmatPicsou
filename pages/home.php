...
<html lang="fr">
  <head>
    ...
    <script src="public/js/jquery-3.2.0.min.js"> </script>
        ...
        <body>
            <header>
               <nav class="navbar  fixed-top navbar-expand-sm navbar-toggleable-md navbar-dark bg-primary">
                ...
                <div class="container-fluid">
                    <br>
                <br><br>
                   <h1 class="text-center page-header"> Souhaits de formation CPF</h1>
                    <hr>
                </div>
            ...
            <form action="index.php" method="POST">
                ...
                <div class="container">
                    <div class="row well">
                        ...
                        <div class="col-sm-12 col-md-6">
                           <label class="control-label" style="font-size : 1.5em;"> Souhaitez vous des informations complémentaires pour compléter le document de l'Agefos PME (accessible dans la rubrique téléchargement de cette application) ? </label><br><br>
                                                        <hr style="width:80%;">
                        <div class="row">
